...
```sh
git clone git@github.com:curryfromuestc/chisel-template-curry.git
cd chisel-template-curry
```
...
#### Commit your changes
```sh
git commit -m 'Starting chisel-template-curry'
...
```sh
mill chisel-template-curry.test
```
