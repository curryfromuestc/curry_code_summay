...
### scala.ScalaReflectionException: value adjustedExpE4M3 is not a method
...
action parameters:
uri: file://<WORKSPACE>/src/main/scala/fpu/core/FP8Converter.scala
text:
```scala
package fpu.core
