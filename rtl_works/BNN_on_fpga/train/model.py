...
class LeNet(nn.Module):
    def __init__(self, num_classes=10, T=4):
        ...
        self.fc1 = layer_BinaryLinear(16*8*8, 120, step_mode='s')
        self.fc2 = layer_BinaryLinear(120, 84, step_mode='s')
        self.fc3 = layer_BinaryLinear(84, num_classes, step_mode='s')
    def forward(self, x):
