...
#
# Script generated by Vivado on Sun Nov 03 22:54:24 +0800 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ROM_conv2.sh
...
#
# Usage        : ROM_conv2.sh
#                ROM_conv2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ROM_conv2.sh [-reset_run]
#                ROM_conv2.sh [-reset_log]
#                ROM_conv2.sh [-help]
#
...
# script info
echo -e "ROM_conv2.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ROM_conv2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ROM_conv2 xil_defaultlib.ROM_conv2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ROM_conv2 -key {Behavioral:sim_1:Functional:ROM_conv2} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ROM_conv2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ROM_conv2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ROM_conv2.sh [-help]\n\
Usage: ROM_conv2.sh [-step]\n\
Usage: ROM_conv2.sh [-lib_map_path]\n\
Usage: ROM_conv2.sh [-reset_run]\n\
Usage: ROM_conv2.sh [-reset_log]\n\
Usage: ROM_conv2.sh [-keep_index]\n\
Usage: ROM_conv2.sh [-noclean_files]\n\n\
